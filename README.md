...
<p align="center">
  <strong>A sleek, frameless, and modern media player built with Python and PySide6.</strong><br>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Qt_PySide6-41CD52?style=for-the-badge&logo=qt&logoColor=white" alt="PySide6">
...
* 📝 **Smart Subtitles:** Native `.srt` parsing engine built from scratch using RegEx. Automatically loads subtitles with the same filename as the video.
* 🧠 **Playback Memory:** Remembers exactly where you left off. Close the app and resume your video right from the last timestamp.
